...
import { Wallet, Lock, Sun, Moon, CheckCircle2, Award, ChevronDown } from 'lucide-react';
              ...
              <div className="flex items-center gap-2">
                <div className="hidden md:flex flex-col items-end px-3 py-1 rounded-xl bg-amber-50 dark:bg-slate-800/80 border border-amber-200/60 dark:border-slate-700">
                  ...
                  <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3 text-emerald-500" /> {activeWalletType === '1am' ? '1am Wallet Active' : 'Preprod Active'}
                  </span>
                </div>
                <button
