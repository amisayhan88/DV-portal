...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.studentGpaScaled) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named studentGpaScaled');
    }
    if (typeof(witnesses_0.degreeIdHash) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named degreeIdHash');
    }
    ...
    this.circuits = {
      ...
      proveGpaThreshold: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const credentialHash_0 = args_1[1];
        const minGpaScaled_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveGpaThreshold',
                                     'argument 1 (as invoked from Typescript)',
                                     'cac.compact line 40 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(credentialHash_0.buffer instanceof ArrayBuffer && credentialHash_0.BYTES_PER_ELEMENT === 1 && credentialHash_0.length === 32)) {
        ...
        if (!(typeof(minGpaScaled_0) === 'bigint' && minGpaScaled_0 >= 0n && minGpaScaled_0 <= 65535n)) {
          __compactRuntime.typeError('proveGpaThreshold',
        ...
        const result_0 = this._proveGpaThreshold_0(context,
                                                   partialProofData,
                                                   credentialHash_0,
                                                   minGpaScaled_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
      ...
      proveDegreeMatch: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`proveDegreeMatch: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const credentialHash_0 = args_1[1];
        const expectedDegreeHash_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveDegreeMatch',
                                     'argument 1 (as invoked from Typescript)',
                                     'cac.compact line 48 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(credentialHash_0.buffer instanceof ArrayBuffer && credentialHash_0.BYTES_PER_ELEMENT === 1 && credentialHash_0.length === 32)) {
        ...
        if (!(expectedDegreeHash_0.buffer instanceof ArrayBuffer && expectedDegreeHash_0.BYTES_PER_ELEMENT === 1 && expectedDegreeHash_0.length === 32)) {
          __compactRuntime.typeError('proveDegreeMatch',
                                     'argument 2 (argument 3 as invoked from Typescript)',
                                     'cac.compact line 48 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(credentialHash_0).concat(_descriptor_0.toValue(expectedDegreeHash_0)),
        ...
        const result_0 = this._proveDegreeMatch_0(context,
                                                  partialProofData,
                                                  credentialHash_0,
                                                  expectedDegreeHash_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
  ...
  _studentGpaScaled_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.studentGpaScaled(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 65535n)) {
      __compactRuntime.typeError('studentGpaScaled',
                                 'return value',
                                 'cac.compact line 25 char 1',
                                 'Uint<0..65536>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _degreeIdHash_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.degreeIdHash(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('degreeIdHash',
                                 'return value',
                                 'cac.compact line 26 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _issueCredential_0(context, partialProofData, credentialHash_0) {
    __compactRuntime.assert(this._equal_0(this._publicKey_0(this._localSecretKey_0(context,
                                                                                   partialProofData),
                                                            __compactRuntime.convertFieldToBytes(32,
                                                                                                 0n,
                                                                                                 'cac.compact line 29 char 47')),
  ...
  _verifyCredential_0(context, partialProofData, credentialHash_0) {
    ...
    __compactRuntime.assert(status_0 === 1,
                            'Credential is not valid or has been revoked');
    return true;
  }
  _proveGpaThreshold_0(context,
                       partialProofData,
                       credentialHash_0,
                       minGpaScaled_0)
  {
    const status_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               ...
                                                                               [
                                                                                ...
                                                                                { popeq: { cached: false,
                                                                                           result: undefined } }]).value);
    __compactRuntime.assert(status_0 === 1, 'Credential is not valid');
    const actualGpa_0 = this._studentGpaScaled_0(context, partialProofData);
    __compactRuntime.assert(actualGpa_0 >= minGpaScaled_0,
                            'GPA below required verification threshold');
    return true;
  }
  _proveDegreeMatch_0(context,
                      partialProofData,
                      credentialHash_0,
                      expectedDegreeHash_0)
  {
    const status_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               ...
                                                                               [
                                                                                ...
                                                                                { popeq: { cached: false,
                                                                                           result: undefined } }]).value);
    __compactRuntime.assert(status_0 === 1, 'Credential is not valid');
    __compactRuntime.assert(this._equal_1(this._degreeIdHash_0(context,
                                                               partialProofData),
                                          expectedDegreeHash_0),
                            'Degree mismatch in zero-knowledge proof');
    return true;
  }
  _revokeCredential_0(context, partialProofData, credentialHash_0) {
    __compactRuntime.assert(this._equal_2(this._publicKey_0(this._localSecretKey_0(context,
                                                                                   partialProofData),
                                                            __compactRuntime.convertFieldToBytes(32,
                                                                                                 0n,
                                                                                                 'cac.compact line 56 char 47')),
                                          _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'Only accredited institution can revoke credentials');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
...
const _dummyContract = new Contract({
  ...
  studentGpaScaled: (...args) => undefined,
